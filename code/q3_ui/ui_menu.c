...
static void Main_MenuDraw( void ) {
	...
	if (uis.demoversion) {
		...
		UI_DrawString( 320, 450 - SMALLCHAR_HEIGHT - 4, "Arena Unlimited 2022 "AU_VERSION" https://miraris.do.am/", UI_CENTER|UI_SMALLFONT, color );
		UI_DrawString( 320, 450, "Miraris Interactive 2022", UI_CENTER|UI_SMALLFONT, color );
	}
}
