...
#define MAX_RENDEREDPIXELS 1022
...
static imageSource_t quakeImageList[] = {
	...
	{ 5, "models/players/sarge/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/razor/icon_id.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/mynx/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/doom/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/bitterman/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/ranger/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/xaero/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
...
static imageSource_t uieImageList[] = {
	{ 100, "icons/iconw_railgun1.tga", 1.0, 0, NULL, 0.0, 0 },	// displayed on first pass
	{ 100, "menu/art/level_complete4.tga", 1.0, 0, "menu/uie_art/uie2.tga", 0.9, 0 },
	{ 100, "menu/art/level_complete4.tga", 1.0, 0, "menu/uie_art/uie.tga", 0.9, 0 }
};
...
//	{ CMODE_TEXT, "", { "", 0, 0, 0 } },
	{ CMODE_TEXT, "Arena Unlimited", {"Miraris", "Interactive", 0, 0  } },
	{ CMODE_TEXT, "Programming", {"Danil_Dm", "ID Software", "Mix3r", "Leilei"} },
	{ CMODE_TEXT, "Map design", {"Danil_Dm", "Vovan_Vm", "ID Software", "Sago"} },
	{ CMODE_TEXT, "UI design", {"purpleblaze", "Danil_Dm", 0, 0} },
	{ CMODE_TEXT, "Game design", {"Danil_Dm", "ID Vovan_Vm", "ID Software", 0} },
	{ CMODE_TEXT, "Art", { "purpleblaze", "Danil_Dm", 0, 0 } },
	{ CMODE_TEXT, "Logo", { "purpleblaze", 0, 0, 0 } },
	{ CMODE_TEXT, "UI Enhanced", { "HypoThermia", 0, 0, 0 } },
...
static dateImageList_t uie_dateImages[] = {
	{ 25, 11, { 0, "menu/uie_art/image2512.tga", 1.0, 0, NULL, 1.0, 0 }},
	{ 21, 0, { 0, "menu/uie_art/imagebday.tga", 1.0, 0, "menu/uie_art/image2101.tga", 1.0, 0 }}
};
...
static void Credits_Init( void )
{
	...
	if (p < 0.3) {
		trap_Cmd_ExecuteText( EXEC_APPEND, "music music/fla22k_01_intro music/fla22k_01_loop\n");
	}
	else if (p < 0.6) {
