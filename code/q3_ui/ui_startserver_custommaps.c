...
static const char* maptype_icon[NUM_GAMETYPES] = {
	...
	"uie_icons/iconf_red",		// GT_CTF
	"uie_icons/iconf_red",		// GT_1FCTF
	"uie_icons/iconf_red",		// GT_OBELISK
	"uie_icons/iconf_red",		// GT_HARVESTER
	"uie_icons/iconf_red",		// GT_ELIMINATION
	"uie_icons/iconf_red",		// GT_CTF_ELIMINATION
	"uie_icons/iconf_red",		// GT_LMS
	"uie_icons/iconf_red",		// GT_DOUBLE_D
	"uie_icons/iconf_red"		// GT_DOMINATION
};
