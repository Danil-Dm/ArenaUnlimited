	...
	int ctrlpage)
{
	...
	common->fight.generic.x		= 640-128;
	...
	common->maptext.style  				= UI_CENTER|UI_GIANTFONT;

	common->bottext.generic.type			= MTYPE_PTEXT;
	common->bottext.generic.x			= 64 + 128;
	...
	common->bottext.style  				= UI_CENTER|UI_GIANTFONT;

	common->itemtext.generic.type			= MTYPE_PTEXT;
	common->itemtext.generic.x			= 64 + 256;
	...
	common->itemtext.style  				= UI_CENTER|UI_GIANTFONT;

	common->servertext.generic.type			= MTYPE_PTEXT;
	common->servertext.generic.x			= 64 + 384;
	...
	common->servertext.style  				= UI_CENTER|UI_GIANTFONT;
