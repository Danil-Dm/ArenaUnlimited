...
set cc=lcc -DMISSIONPACK -DQ3_VM -S -Wf-target=bytecode -Wf-g -I..\..\..\code\game -I..\..\..\code\qcommon %1
...
cd windows_scripts
cd ..\..
copy ArenaUnlimited_Code\windows\baseoa\vm\qagame.qvm ArenaUnlimited\vm\qagame.qvm
copy ArenaUnlimited_Code\windows\baseoa\vm\cgame.qvm ArenaUnlimited\vm\cgame.qvm
copy ArenaUnlimited_Code\windows\baseoa\vm\ui.qvm ArenaUnlimited\vm\ui.qvm
